...
For ($i=1; $i -le 3; $i++) {
        Show-FormProcess "$source" "$path\linux-2.6.18.tar.bz2"
        Write-Host "Загрузка завершена $element" -BackgroundColor red -ForegroundColor White
    }
